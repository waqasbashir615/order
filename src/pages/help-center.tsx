          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-center py-4 space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-[#E3B24A] rounded-lg flex items-center justify-center">
                  <Car className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h1 className="text-xl font-bold text-[#393939]">MXDrive</h1>
                  <p className="text-sm text-[#393939CC]">Help Center</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <Button variant="ghost" className="text-[#393939CC] hover:text-[#393939]">
                  Go to MXDrive Business
                </Button>
                <Button className="bg-[#E3B24A] hover:bg-[#D4A23F] text-white">
                  Support Sign In
                </Button>
              </div>
            </div>
